...
parser.add_argument('--agent', type=str, default='./data/configurations_ac/A2C.yml')
parser.add_argument('--episodes', type=int, default=10)
parser.add_argument('--logdir', type=str, default='./results_final_3/')
...
if __name__ == '__main__':
    ...
    for ep in range(1):
        ...
        env = utils.setup_simulation_ac_reject(config, exp.overlay, train_process, vnfs, chains)
